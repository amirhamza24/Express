    ...
    return (
        <div className='w-50 mx-auto'>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <br />
                <input className='w-50 mb-4 rounded ps-2' onBlur={handlePasswordBlur} type="password" name="password" id="password" placeholder='Your Password Here' required />
                <br />
